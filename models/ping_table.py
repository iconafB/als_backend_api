...
class ping_tbl(SQLModel,table=True):
    pk:int=Field(primary_key=True,default=None,description="Primary key for each pinged cell number")
    cell:str=Field(foreign_key="info_tbl.cell",index=True,nullable=False,max_length=10,description="Pinged cell number")
